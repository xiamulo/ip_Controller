...
class abyIpGetter:
    ...
    def __init__(self):
        ...
        self.api_url = 'https://api-ip.abuyun.com/obtain?license=L370EDEE969545EP&sign=abb0d015dab79e64f21e8f84570e2692&format=text&cnt=3'
        self.proxy_list = []
        self.good_proxy_list = []
        self.pool = Pool(3)
        self.server = redis_util(type="ips",db=2)
